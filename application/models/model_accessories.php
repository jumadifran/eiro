...
/**
 * Description of model_accessories
 *
 * @author hp
 */
class model_accessories extends CI_Model {
  ...
  function select_by_id($id) {
    return $this->db->get_where('accessories', array('id' => $id))->row();
  }
  ...
  function update($id) {
    ...
    $where = array("id" => $id);
    if ($this->db->update('accessories', $data, $where)) {
      echo json_encode(array('success' => true));
    }
    else {
      echo json_encode(array('msg' => $this->db->_error_message()));
  ...
  function delete() {
    ...
    $where = array("id" => $id);
    if ($this->db->delete('accessories', $where)) {
      echo json_encode(array('success' => true));
    }
    else {
      echo json_encode(array('msg' => $this->db->_error_message()));
