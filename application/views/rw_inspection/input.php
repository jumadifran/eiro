...
?>
<div style="width: 100%">
    <form id="rw_inspection_input_form" method="post" novalidate >
        <table width="99%">    
            <tr valign="top">
                <td width="100%">  
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="id_po_item_rw_inspection" required="true" id="id_po_item_rw_inspection" class="easyui-combogrid" style="width:100%;"/>
                                <script>

                                    $('#id_po_item_rw_inspection').combogrid({
                                        url: base_url + 'rw_inspection/get_item_po',
                                        idField: 'valfield',
                                        textField: 'myfield',
                                        mode: 'remote',
                                        columns: [[
