                            ...
                            <script type="text/javascript">
                                $('#invoice_proforma_invoice_id').combogrid({
                                    ...
                                    onSelect: function (val, row) {
                                        ...
                                        $('#invoice_down_payment').numberbox('setValue', row.down_payment);
                                        $('#invoice_order_amount').numberbox('setValue', row.total);
                                        $('#invoice_amount').numberbox('setValue', row.down_payment_nominal);
                                        $('#invoice_amount_due').numberbox('setValue', row.down_payment_nominal);
