...
$tbl = '<table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 20px;">
        <tr>
            <td width="50%" style="line-height: 10px;">' . $invoice->order_description . '</td>
            <td width="5%" style="line-height: 10px;">' . $invoice->currency_code . '</td>
            <td width="15%" style="line-height: 10px;">' . number_format($invoice->total_order) . '</td>
            <td width="10%" style="line-height: 10px;" align="center">' . $invoice->order_amount_percentage . ' %' . '</td>
            <td width="5%" style="line-height: 10px;">' . $invoice->currency_code . '</td>
            <td width="15%" style="line-height: 10px;" align="right">' . number_format($invoice->total_order) . '</td>
        </tr>
    </table>';

$my_pdf->writeHTML($tbl, true, false, false, false, '');

$tbl = '<table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 5px;">
        <tr>
            <td width="50%" style="line-height: 10px;">' . $invoice->dp_receive_description . '</td>
            <td width="5%" style="line-height: 10px;">&nbsp;</td>
            <td width="15%" style="line-height: 10px;">&nbsp;</td>
            <td width="10%" style="line-height: 10px;" align="center">&nbsp;</td>
            <td width="5%" style="line-height: 10px;">' . $invoice->currency_code . '</td>
            <td width="15%" style="line-height: 10px;border-bottom: 1px solid #000;" align="right">(&nbsp;' . number_format($invoice->dp_receive_amount) . '&nbsp;)</td>
        </tr>
    </table>';
...
$tbl = '<table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 5px;">
        ...
        <tr>
            ...
            <td style="line-height: 10px;">&nbsp;</td>
            <td style="line-height: 10px;" align="center">10 %</td>
