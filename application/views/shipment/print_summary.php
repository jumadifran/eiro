...
$tbl = '    <table width="100%" border="1" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td width="8%" align="center" style="border: .1px solid black;line-height:7px;"><b>Client PO No</b></td>
                <td width="8%" align="center" style="border: .1px solid black;line-height:7px;"><b>Ebako Code</b></td>
                <td width="8%" align="center" style="border: .1px solid black;line-height:7px;"><b>Cus.Code</b></td>
                <td width="5%" align="center" style="border: .1px solid black;line-height:7px;"><b>T.Item</b></td>
                <td width="5%" align="center" style="border: .1px solid black;line-height:7px;"><b>T.Box</b></td>
                <td width="20%" align="center" style="border: .1px solid black;line-height:7px;"><b>Finishing</b></td>
                <td width="8%" align="center" style="border: .1px solid black;line-height:7px;"><b>Material</b></td>
                <td width="14%" align="center" style="border: .1px solid black;line-height:7px;"><b>Remark</b></td>
                <td width="14%" align="center" style="border: .1px solid black;line-height:7px;"><b>Description</b></td>
                <td width="8%" align="center" style="border: .1px solid black;line-height:7px;"><b>Tagfor</b></td>
            </tr>
        </thead>';
$counter = 10;
$no = 1;
...
foreach ($shipment_item as $result) {
    $tbl .= '<tr>
        ...
        <td width="8%" align="center" style="border-right-color:#000000;border-right-width:0.1px;border-right-style:solid;line-height:5px;">' . $result->po_client_no . '</td>
        ...
        <td width="5%" align="center" style="border-right-color:#000000;border-right-width:0.1px;border-right-style:solid;line-height:5px;">' . $result->pcs_qty . '</td>
        <td width="5%" align="center" style="border-right-color:#000000;border-right-width:0.1px;border-right-style:solid;line-height:5px;">' . $result->box_qty . '</td>
        ...
        <td width="8%" align="center" style="border-right-color:#000000;border-right-width:0.1px;border-right-style:solid;line-height:5px;">' . $result->tagfor . '</td>
    </tr>';
$counter--;
}
