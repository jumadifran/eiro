<div id="rw_inspection_summary_toolbar" style="padding-bottom: 2px;">   
    <form id="rw_inspection_summary_search_form" onsubmit="return false" style="margin: 0">
        E.Code/C.Code/C.Name/PoNo : 
        <input type="text" size="20" class="easyui-validatebox" name="q" onkeypress="if (event.keyCode === 13) {
                    rw_inspection_summary_search();
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="rw_inspection_summary_search()">Find</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="print_rw_inspection2('single')"></a>
        
    </form>
</div>
<table id="rw_inspection_summary" data-options="
       url:'<?php echo site_url('rw_inspection_summary/get') ?>',
       method:'post',
       border:false,
       singleSelect:true,
       fit:true,
       ...
       striped:true,
       idField:'id',
       toolbar:'#rw_inspection_summary_toolbar'">
    <thead>
        <tr>
            ...
            <th field="rw_inspection_date" width="120" align="center" formatter="myFormatDate">Inspection Date</th>
...
<script rw_inspection_summary="text/javascript">
    $(function () {
        $('#rw_inspection_summary').datagrid({
            rowStyler: function(index, row) {
                
//                if (date1.toDateString() == row.rw_inspection_date.toDateString()) {
...
<script type="text/javascript" src="<?php echo base_url() ?>js/rw_inspection_summary.js"></script>
