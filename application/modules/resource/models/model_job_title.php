...
/**
 * Description of model_job_title
 *
 * @author hp
 */
class model_job_title extends CI_Model {
    ...
    function select_by_id($id) {
        return $this->db->get_where('job_title', array('id' => $id))->row();
    }
    ...
    function update($data, $where) {
        ...
        $data['created_at'] = "now()";
        if ($this->db->update('job_title', $data, $where)) {
            echo json_encode(array('success' => true));
        } else {
            echo json_encode(array('msg' => $this->db->_error_message()));
        }
    ...
    function delete($where) {
        if ($this->db->delete('job_title', $where)) {
            echo json_encode(array('success' => true));
        } else {
            echo json_encode(array('msg' => $this->db->_error_message()));
        }
